...
export function buildAccessHints(member: AuthenticatedMember): AccessHints {
  ...
  const canManageRecurring = allowed(member, { type: "manage_recurring" });
  ...
  return {
    navigation: {
      ...
      canOpenReimbursements: canBrowse,
      canOpenRecurring: canManageRecurring,
