...
VALUES
  ...
  (
    'rule-blocked-archived-category',
    'household-demo',
    'E2E 封存分類週期支出',
    'expense',
    250000,
...
VALUES
  ...
  (
    'occurrence-blocked-archived-category',
    'household-demo',
    'rule-blocked-archived-category',
    '2026-06',
    DATE '2026-06-11',
  ...
  (
    'occurrence-blocked-disabled-member',
    'household-demo',
    'rule-blocked-disabled-member',
    '2026-06',
    DATE '2026-06-12',
...
SET "targetDate" = EXCLUDED."targetDate",
    ...
    "postingActorKind" = EXCLUDED."postingActorKind",
    "postedByMemberId" = EXCLUDED."postedByMemberId",
