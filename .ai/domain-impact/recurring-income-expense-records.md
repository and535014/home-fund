...
- prototype_states_or_flows:
  ...
  - Rule forms need schedule-anchor selection for fixed day 1-28 or `每月底`, amount, category, income/expense type, member attribution, and expense payment source.
...
- tdd_domain_tests:
  - Creating a rule validates actor role, fixed day 1-28 or month-end schedule anchor, category/type compatibility, amount, and member/payment-source shape.
