...
- `提醒入帳` 的 recurring occurrence 在確認前不能進 ledger totals、category totals 或 reimbursement totals；Search 可將它顯示為獨立的 pending occurrence result，但不得偽裝成 ordinary ledger record。
