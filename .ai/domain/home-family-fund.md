...
| 42 | CSV import confirmed | Confirm CSV import batch | Admin or Finance manager | The actor confirms the reviewed valid rows should become ledger records. |
...
| 44 | CSV import rows rejected | Reject CSV import rows | System | Invalid or unauthorized rows are reported with row-level reasons and do not mutate financial records. |
