...
| Reimbursement payment | Evidence that real-world reimbursement money was paid for a reimbursement batch, including amount, paid-to member, paid-from source, payment method, paid time, actor, and optional reference or note. | Reimbursement |
| Payment source for reimbursement | The source from which reimbursement money was paid, such as household fund, cash, bank account label, or other MVP-approved source. This is distinct from an expense's `paymentSource`. | Reimbursement |
| Payment method for reimbursement | The real-world method used to reimburse a member, such as cash, bank transfer, LINE Pay, or other MVP-approved method. | Reimbursement |
...
| 38 | Reimbursement payment details captured | Enter reimbursement payment details | Finance manager | The finance manager provides the paid-from source, payment method, paid-to member, paid time, amount, and optional reference/note before settlement completes. |
