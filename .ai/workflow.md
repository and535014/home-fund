...
- current_stage: Behavior Spec / BDD / E2E review for edit/delete ledger records.
- recommended_resume_gate: Feature Technical Design after explicit approval of `.ai/spec/edit-delete-ledger-records.md`.
- recommended_next_skill: feature-technical-design for the approved edit/delete ledger records change; target-aware-release only if a stricter release target is selected; artifact-prune only if explicitly requested.
