...
- current_stage: Target-Aware Release review for batch search record actions.
- recommended_resume_gate: Learning Loop for `batch-search-record-actions` after user approval, or Artifact Compression if learning is explicitly skipped.
- recommended_next_skill: learning-loop for local_dev signals; artifact-compression if user explicitly skips learning.
