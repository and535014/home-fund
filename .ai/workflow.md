...
- current_stage: Category visual identity and ordering Verification is drafted and awaiting review.
- recommended_resume_gate: Target-Aware Release for category visual identity and ordering after verification approval; optional manual Artifact Prune only if explicitly requested.
- recommended_next_skill: target-aware-release for local_dev readiness after approval; artifact-prune only if explicitly requested.
...
- release: completed record list detail modal local_dev readiness is summarized in `.ai/archive/archive-record-list-detail-modal-2026-06-20.md`; completed desktop layout redesign local_dev readiness is summarized in `.ai/archive/archive-desktop-product-structure-layout-redesign-2026-06-20.md`; completed remove standalone create-record entry local_dev readiness is summarized in `.ai/archive/archive-remove-standalone-create-record-entry-2026-06-20.md`; v2 local_dev release readiness at `.ai/release/home-family-fund-local-dev-readiness.md` includes prior admin-only category management and admin Google OAuth/member invitations work and supports `local_dev`.
