...
- current_stage: Learning Loop review for record search, sort, and filter.
- recommended_resume_gate: Artifact Compression for `record-search-sort-filter` after explicit Learning Loop approval.
- recommended_next_skill: artifact-compression after Learning Loop approval; learning-loop if this learning plan needs revision; artifact-prune only if explicitly requested.
