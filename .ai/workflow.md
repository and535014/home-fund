...
- current_stage: Learning Loop review for batch search record actions.
- recommended_resume_gate: Artifact Compression for `batch-search-record-actions` after user approval.
- recommended_next_skill: artifact-compression for completed local_dev batch search record actions slice.
