...
- current_stage: Behavior Spec / BDD / E2E review for batch search record actions.
- recommended_resume_gate: Feature Technical Design for `batch-search-record-actions` after user approval.
- recommended_next_skill: feature-technical-design for approved batch delete/refund search actions; target-aware-release for stricter release target.
