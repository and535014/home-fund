...
- current_stage: Feature Technical Design review for batch search record actions.
- recommended_resume_gate: TDD Implementation for `batch-search-record-actions` after user approval.
- recommended_next_skill: tdd-implementation for approved batch delete/refund search actions; target-aware-release for stricter release target.
