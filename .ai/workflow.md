...
- current_stage: Artifact Compression review for record detail reimbursement.
- recommended_resume_gate: next Intent Intake, optional stricter-target release readiness, or explicit artifact-prune.
- recommended_next_skill: intent-intake for new product work; target-aware-release for stricter release target; artifact-prune only if explicitly requested.
