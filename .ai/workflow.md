...
- current_stage: Feature Technical Design review for edit/delete ledger records.
- recommended_resume_gate: TDD Implementation after explicit approval of `.ai/technical-design/edit-delete-ledger-records.md`.
- recommended_next_skill: tdd-implementation for the approved edit/delete ledger records change; target-aware-release only if a stricter release target is selected; artifact-prune only if explicitly requested.
