...
- current_stage: Experience Prototype review for edit/delete ledger records.
- recommended_resume_gate: Behavior Spec / BDD / E2E after explicit approval of `.ai/prototype/edit-delete-ledger-records.md`.
- recommended_next_skill: behavior-spec for the approved edit/delete ledger records change; target-aware-release only if a stricter release target is selected; artifact-prune only if explicitly requested.
