...
- current_stage: Experience Prototype review for batch search record actions.
- recommended_resume_gate: Behavior Spec / BDD / E2E for `batch-search-record-actions` after user approval.
- recommended_next_skill: behavior-spec for approved batch delete/refund search actions; target-aware-release for stricter release target.
